...
def yolo_detect(pathIn,
    ...
    # 显示预测所花费时间
    #print('YOLO模型预测图片花费了 {:.2f} 秒'.format(end - start))
    ...
    if len(idxs) > 0:
        ...
        for i in idxs.flatten():
            ...
            print(i+1, ",",x,",",y,",",x+w,",",y+h,",",confidences[i],",",classIDs[i])
    # 输出结果图片
    if pathOut is None:
...
for i in range(1,1000):
    p = i
    print("第", p, "张图片")
    pathIn = './Track4/'+str(p)+'.jpg'
    pathOut = './Track4out/'+str(p)+'.jpg'
